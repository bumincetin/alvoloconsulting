...
export const translations: Record<Locale, TranslationType> = {
  ...
  tr: {
    ...
    hero: {
      ...
      subtitle: 'Sadece tavsiye vermiyoruz. Genişlemenizi mimariyoruz. İtalya ve Türkiye arasında hareket eden KOBİ\'ler ve Profesyoneller için veri odaklı finansal köprü.',
    ...
    services: {
      ...
      integrationServices: [
        { title: 'Burs Başvurusu Danışmanlığı', description: 'Üniversite ve diğer kurumların burslarına başvuru süreçlerinde rehberlik.' },
        { title: 'Oturum İzni (Permesso di Soggiorno)', description: 'İtalya\'da yasal olarak ikamet etmek için gerekli izinlerin alınması.' },
        { title: 'Konaklama Danışmanlığı', description: 'Öğrenci yurtları, kiralık daireler ve diğer konaklama seçenekleri bulma.' },
      ...
      financialServices: [
        ...
        { title: 'Finansal Planlama ve Bütçe Yönetimi', description: 'İşletmeniz için kapsamlı finansal planlama ve bütçe yönetimi.' },
        ...
        { title: 'Risk Yönetimi ve Sigorta Planlaması', description: 'İşletmeniz için risk yönetimi ve sigorta planlaması.' },
        { title: 'Sürekli Finansal Danışmanlık ve Raporlama', description: 'İlk yıl ve devamında sürekli finansal danışmanlık ve raporlama desteği.' },
      ],
    },
    expansion: {
      left: {
    ...
    methodology: {
      ...
      steps: [
        { num: '01', title: 'Keşif', description: 'Yapılandırılmış danışmanlıklar aracılığıyla iş bağlamınıza, veri ortamınıza ve hedeflerinize derinlemesine dalış.' },
        ...
        { num: '03', title: 'Geliştirme', description: 'Düzenli kontrol noktalarıyla yinelemeli inşa, süreç boyunca iş hedefleriyle uyum sağlama.' },
    ...
    footer: {
      ...
      companyAddress: 'Via Valsugana 6, 20139 Milan, İtalya',
    ...
    pricing: {
      ...
      packages: [
        ...
        },
        {
          ...
          features: ['Temel\'deki her şey', 'Oturum izni desteği', 'Konaklama arama', 'Öncelikli destek', 'Video görüşmeleri'],
          cta: 'Başla',
          popular: true,
        },
        {
          ...
          features: ['Profesyonel\'deki her şey', 'Şirket kurulumu', 'Vergi planlaması', 'Özel hesap yöneticisi', 'Yerinde destek'],
          cta: 'Bize Ulaşın',
        },
      ],
    },
