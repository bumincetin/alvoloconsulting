...
export const briefContent: Record<Locale, BriefContent> = {
  ...
  en: {
    ...
    sub: "Five questions, and a proposal drawn the way our practice runs: modules, phases and desks, before the first conversation. There is no price list and nothing to download.",
    intro: {
      ...
      points: ["Five questions", "About three minutes", "A proposal sheet you can forward"],
    ...
    options: {
      ...
      direction: [
        { id: "italy", title: "Into Italy", hint: "Milano and Roma: incorporation, permits, tax and banking" },
    ...
    proposal: {
      ...
      formatReason: {
        ...
        retainer: "Its breadth calls for a standing retainer rather than a single project.",
      ...
      modules: {
        ...
        holding: { name: "Holding & group structure", description: "Whether a holding layer pays for itself, and where the shareholders receive their dividends." },
  ...
  tr: {
    ...
    sub: "Beş soru ve uygulamamızın işleyişine göre çizilmiş bir teklif: modüller, aşamalar ve masalar, ilk görüşmeden önce. Fiyat listesi yok, indirilecek bir şey yok.",
    intro: {
      ...
      points: ["Beş soru", "Yaklaşık üç dakika", "İletebileceğiniz bir teklif sayfası"],
    ...
    options: {
      ...
      direction: [
        { id: "italy", title: "İtalya'ya", hint: "Milano ve Roma: şirket kuruluşu, izinler, vergi ve bankacılık" },
    ...
    proposal: {
      ...
      formatReason: {
        ...
        retainer: "Kapsamının genişliği, tek bir proje yerine sürekli danışmanlık gerektirir.",
      ...
      modules: {
        ...
        holding: { name: "Holding ve grup yapısı", description: "Holding katmanının kendini amorti edip etmediği ve ortakların temettülerini nereden alacağı." },
  ...
  it: {
    ...
    sub: "Cinque domande e una proposta disegnata come lavora il nostro studio: moduli, fasi e desk, prima della prima conversazione. Nessun listino, nulla da scaricare.",
    intro: {
      ...
      points: ["Cinque domande", "Circa tre minuti", "Una scheda di proposta da inoltrare"],
    ...
    options: {
      ...
      direction: [
        { id: "italy", title: "Verso l'Italia", hint: "Milano e Roma: costituzione, permessi, fisco e banche" },
    ...
    proposal: {
      ...
      formatReason: {
        ...
        retainer: "La sua ampiezza richiede un retainer continuativo anziché un singolo progetto.",
      ...
      modules: {
        ...
        holding: { name: "Holding e struttura di gruppo", description: "Se un livello di holding si ripaga, e dove i soci incassano i dividendi." },
