...
export const shoreContent: Record<Locale, ShoreContent> = {
  en: {
    ...
    gate: {
      ...
      lead: "Alvolo begins where the Duomo's spires meet the fog: a market of sixty million people, entered through a notary's deed, a Partita IVA and a bank that will open its doors. The paperwork is not decoration. It is how a company is taught to survive its first Italian winter, and the first thing this shore asks you to understand.",
      body: "Cross the piazza and the Galleria lifts out of the mist, its glass roof lit from inside like a lantern the size of a city block. Above the roofs a pale moon holds its place, patient, half hidden. Nothing here is in a hurry. Neither, for the next few weeks, is your incorporation.",
    ...
    lessons: {
      ...
      body: "Each phase is a walk, not a lecture. You arrive at the audit, cross the structuring, sit with the notary, and leave with a company that can invoice.",
      items: [
        ...
        { num: "05", title: "The Pale Moon", alt: "Süreklilik", text: "Why the corridor stays open after the first invoice, and what the mandate does with it.", time: "ongoing" },
      ],
    },
    eternity: {
      eyebrow: "Chapter 04 — Continuity",
      word: "Continuity",
      body: "The gate does not close behind you. Tax filings, payroll, supplier reviews and the next expansion run on the same path — it is always the same corridor, and never the same light.",
  ...
  tr: {
    ...
    gate: {
      ...
      lead: "Alvolo, Duomo'nun kulelerinin sisle buluştuğu yerde başlar: noter senedi, Partita IVA ve kapılarını açacak bir bankayla girilen altmış milyonluk bir pazar. Evrak süs değildir. Bir şirketin ilk İtalyan kışını nasıl atlatacağını öğrenme biçimidir ve bu kıyının sizden anlamanızı istediği ilk şeydir.",
      body: "Meydanı geçin; Galleria sisin içinden yükselir, cam çatısı bir blok büyüklüğünde bir fener gibi içeriden aydınlanır. Çatıların üzerinde solgun bir ay yerini korur, sabırlı, yarı gizli. Burada hiçbir şeyin acelesi yoktur. Önümüzdeki birkaç hafta boyunca kuruluşunuzun da.",
      link: "Koridoru geçin",
      stats: [
    ...
    lessons: {
      ...
      body: "Her aşama bir ders değil, bir yürüyüştür. Denetime varır, yapılandırmayı geçer, noterle oturur ve fatura kesebilen bir şirketle ayrılırsınız.",
      items: [
        ...
        { num: "05", title: "Solgun Ay", alt: "Continuità", text: "Koridor ilk faturadan sonra neden açık kalır ve mandat bununla ne yapar.", time: "sürekli" },
      ],
    },
    eternity: {
      eyebrow: "Bölüm 04 — Süreklilik",
      word: "Süreklilik",
      body: "Kapı arkanızdan kapanmaz. Vergi beyanları, bordro, tedarikçi incelemeleri ve bir sonraki genişleme aynı yolda ilerler — her zaman aynı koridor, asla aynı ışık değil.",
      cta: "Mandatı başlat",
    },
    footer: {
  ...
  it: {
    ...
    gate: {
      ...
      lead: "Alvolo comincia dove le guglie del Duomo incontrano la nebbia: un mercato di sessanta milioni di persone, in cui si entra con un atto notarile, una Partita IVA e una banca disposta ad aprire le porte. Le carte non sono decorazione. Sono il modo in cui a un'impresa si insegna a superare il primo inverno italiano, e la prima cosa che questa sponda ti chiede di capire.",
      body: "Attraversa la piazza e la Galleria emerge dalla foschia, il tetto di vetro acceso dall'interno come una lanterna grande quanto un isolato. Sopra i tetti una luna pallida tiene il suo posto, paziente, mezza nascosta. Qui nulla ha fretta. Nemmeno, per le prossime settimane, la tua costituzione.",
    ...
    lessons: {
      ...
      body: "Ogni fase è una passeggiata, non una lezione. Arrivi all'audit, attraversi la strutturazione, siedi con il notaio e te ne vai con una società che può fatturare.",
      items: [
        ...
        { num: "05", title: "La Luna Pallida", alt: "Süreklilik", text: "Perché il corridoio resta aperto dopo la prima fattura, e cosa ne fa il mandato.", time: "continuativo" },
      ],
    },
    eternity: {
      eyebrow: "Capitolo 04 — Continuità",
      word: "Continuità",
      body: "La porta non si chiude alle tue spalle. Dichiarazioni fiscali, payroll, revisioni dei fornitori e la prossima espansione corrono sullo stesso percorso — è sempre lo stesso corridoio, e mai la stessa luce.",
