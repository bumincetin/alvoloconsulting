  ...
  return (
    <div
      className={`
        ...
        ${hover ? 'transition-all duration-300 hover:border-holographic-cyan/30 hover:shadow-[0_25px_70px_rgba(0,0,0,0.4),0_0_50px_rgba(0,240,255,0.12)] hover:-translate-y-1' : ''}
        ${className}
      `}
    >
      {children}
