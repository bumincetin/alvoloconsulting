...
const getExpansionTurkeyContent = (lang: string) => {
  const content = {
    ...
    en: {
      ...
      step3Desc: "Notarizing the 'Imza Sirküleri'—your master key for all banking and government operations.",
      structure1Title: "Limited Şirket (Ltd)",
    ...
    it: {
      ...
      step3Desc: "Autenticazione della 'Imza Sirküleri'—la tua chiave master per tutte le operazioni bancarie e governative.",
