  ...
  useEffect(() => {
    ...
    const applyRingState = () => {
      ...
      gsap.to(ring, {
        ...
        borderRadius: 999,
        borderColor: targeting ? "rgba(11,138,79,0.9)" : hovering ? "rgba(27,34,48,0.85)" : "rgba(27,34,48,0.45)",
        backgroundColor: hovering && !targeting ? "rgba(27,34,48,0.06)" : "rgba(27,34,48,0)",
        duration: 0.35,
        ease: "power3.out",
        overwrite: "auto",
      });
    ...
    const engageMagnet = (el: HTMLElement, mx: number, my: number) => {
      ...
      gsap.to(ring, {
        ...
        borderColor: "rgba(27,34,48,0.9)",
        backgroundColor: "rgba(27,34,48,0)",
        duration: 0.4,
        ease: "power3.out",
        overwrite: "auto",
      });
